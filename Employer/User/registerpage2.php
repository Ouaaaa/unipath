    ...
    if ($account_id) {
        ...
        if ($stmt = mysqli_prepare($link, $sql)) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                $sqlProfile = "INSERT INTO tblcompany (account_id, company_name, datecreated) VALUES (?, ?, ?)";
                if ($stmtProfile = mysqli_prepare($link, $sqlProfile)) {
                    mysqli_stmt_bind_param($stmtProfile, "iss", $account_id, $companyName, $datecreated);
                    if (mysqli_stmt_execute($stmtProfile)) {
                        ...
                        if ($usertype == 'Employer') {
                            ...
                            header("Location: ../../Jobseeker/User/CareerSearch-Page.php");
                        }
                        exit();
                    } else {
