                            ...
                            <div class="col-lg-9 col-md-9">
                                <div class="menu-wrapper">
                                    ...
                                    <div class="header-btn d-none f-right d-lg-block">
                                        ...
                                        <a href="../../Jobseeker/User/MasterPage.php" class="btn head-btn1">Jobseeker</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Mobile Menu -->
                        ...
                        <article class="job-card">
                            <div class="job-items">
                                ...
                                <div class="job-details">
                                    <h4 class="job-title">
                                        <a href="Login.php?vacancyID=<?= htmlspecialchars($row['job_name']) ?>"><?= htmlspecialchars($row['job_name']) ?></a>
                                    </h4>
                                    <ul class="job-info">
                                ...
                                <div class="items-link items-link2 f-right">
                                    <a href="Login.php" class="job-type"><?= htmlspecialchars($row['job_type']) ?></a>
                                </div>
                            </div>
                        </article>
                    </div>
