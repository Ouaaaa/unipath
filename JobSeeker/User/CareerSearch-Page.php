...
$sql = "SELECT lastname FROM tblprofiles WHERE account_id = ?";
...
// Store the company name in session
                                ...
                                <div class="menu-wrapper">
                                    ...
                                    <div class="main-menu">
                                        <nav class="d-none d-lg-block">
                                            <ul id="navigation">
                                                <li class="active"><a href="#">Career Search</a></li>
                        ...
                        <article class="job-card">
                            <div class="job-items">
                                ...
                                <div class="job-details">
                                    <h4 class="job-title">
                                    <a href="Job-Apply.php?job_id=<?= htmlspecialchars($row['job_id']) ?>&company_id=<?= htmlspecialchars($row['company_id']) ?>"><?= htmlspecialchars($row['job_name']) ?></a>
                                    </h4>
                                    <ul class="job-info">
                                ...
                                <div class="items-link items-link2 f-right">
                                    <a class="job-type" href="Job-Apply.php?job_id=<?= htmlspecialchars($row['job_id']) ?>&company_id=<?= htmlspecialchars($row['company_id']) ?>"><?= htmlspecialchars($row['job_type']) ?></a>
                                </div>
                            </div>
                        </article>
                    </div>
