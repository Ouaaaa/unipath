...
if ($companyID) {
    $query = "SELECT company_name, company_logo , company_about FROM tblcompany WHERE company_id = ?";
    if ($stmt3 = mysqli_prepare($link, $query)) {
        mysqli_stmt_bind_param($stmt3, "i", $companyID);
        mysqli_stmt_execute($stmt3);
        mysqli_stmt_bind_result($stmt3, $companyName, $companyLogo ,$companyAbout);
        ...
        <div class="job-card">
            ...
            <div class="company-title">
                ...
                <nav class="custom-nav">
                    <ul>
                    <li><a href="Company-About.php?company_id=<?php echo urlencode($companyID); ?>" class="active">About</a></li>
                    <li><a href="Company-Jobs.php?company_id=<?php echo urlencode($companyID); ?>">Jobs</a></li>
                    </ul>
                </nav>
            <div class="company-about">
                <p ><i class="fas fa-info-circle"></i> <?php echo htmlspecialchars($companyAbout); ?>
                </p>
            </div>
    </div>
